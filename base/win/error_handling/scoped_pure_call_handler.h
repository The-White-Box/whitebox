...
#ifndef WB_BASE_WIN_ERROR_HANDLING_SCOPED_PURE_CALL_HANDLER_H_
#define WB_BASE_WIN_ERROR_HANDLING_SCOPED_PURE_CALL_HANDLER_H_
...
#endif  // !WB_BASE_WIN_ERROR_HANDLING_SCOPED_PURE_CALL_HANDLER_H_
