...
#include "base/include/windows/scoped_last_error.h"
...
class BaseWindow {
 ...
 public:
   ...
   * @tparam TDerivedWindow
   */
  [[nodiscard]] static R<U<TDerivedWindow>> Create(
    ...
    return !rc ? R<U<TDerivedWindow>>{std::move(window)}
               : R<U<TDerivedWindow>>{rc};
  }
 ...
 private:
  ...
  static LRESULT CALLBACK WindowMessageHandler(_In_ HWND hwnd,
    ...
    if (message == WM_NCCREATE) {
      ...
      {
        ScopedLastError restore_last_error_on_out;
