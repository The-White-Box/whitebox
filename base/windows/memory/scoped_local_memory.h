...
#ifndef WB_BASE_WINDOWS_MEMORY_SCOPED_LOCAL_MEMORY_H_
#define WB_BASE_WINDOWS_MEMORY_SCOPED_LOCAL_MEMORY_H_
...
#endif  // WB_BASE_WINDOWS_MEMORY_SCOPED_LOCAL_MEMORY_H_