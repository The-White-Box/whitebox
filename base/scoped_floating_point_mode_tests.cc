...
GTEST_TEST(ScopedFloatingPointModeTest, SetFlushToZeroModeInScope) {
  ...
  EXPECT_NE(_MM_GET_FLUSH_ZERO_MODE(), static_cast<unsigned>(_MM_FLUSH_ZERO_ON))
...

  {
    ...
    EXPECT_EQ(_MM_GET_FLUSH_ZERO_MODE(),
              static_cast<unsigned>(_MM_FLUSH_ZERO_ON))
...

  {
    ...
    EXPECT_NE(_MM_GET_FLUSH_ZERO_MODE(),
              static_cast<unsigned>(_MM_FLUSH_ZERO_ON))
...
GTEST_TEST(ScopedFloatingPointModeTest, SetDenormalsAreZeroModeInScope) {
  ...
  EXPECT_NE(_MM_GET_DENORMALS_ZERO_MODE(),
            static_cast<unsigned>(_MM_DENORMALS_ZERO_ON))
...

  {
    ...
    EXPECT_EQ(_MM_GET_DENORMALS_ZERO_MODE(),
              static_cast<unsigned>(_MM_DENORMALS_ZERO_ON))
