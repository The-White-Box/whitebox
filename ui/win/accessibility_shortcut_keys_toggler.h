...
#ifndef WB_UI_WIN_ACCESSIBILITY_SHORTCUT_KEYS_TOGGLER_H_
#define WB_UI_WIN_ACCESSIBILITY_SHORTCUT_KEYS_TOGGLER_H_
...
#endif  // !WB_UI_WIN_ACCESSIBILITY_SHORTCUT_KEYS_TOGGLER_H_
